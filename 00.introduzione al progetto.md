...
Nel corso di questo progetto l'intelligenza artificiale (Claude.ai) è stata utilizzata come strumento di supporto in diverse fasi del lavoro. 
- Innanzitutto è stata utilizzata per ampliare l'idea originale del progetto; ha svolto un ruolo di supporto nella generazione di quattro domande di ricerca a partire da un'idea centrale ma piuttosto generale, ovvero lo studio del fenomeno di ritorno all'acquisto dei vinili
- In secondo luogo, è stato fondamentale nella generazione del codice Python, utilizzato per interrogare le API di Discogs e MusicBrainz, analizzare il dataset TikTok scaricato da Kaggle e costruire i dataset storici RIAA e IFPI. Ha inoltre supportato la correzione di problemi tecnici riscontrati nella fase di ricerca dati.
- Infine è stata utilizzata per la correzione di bozze, per la generazione di testi e per una generazione di spiegazioni dei codici realizzati. 

L'utilizzo dell'intelligenza artificiale non ha sostituito il ragionamento critico e le scelte metodologiche, che sono rimaste in capo all'autrice del progetto, ma ha rappresentato uno strumento efficace per accelerare e migliorare la qualità del lavoro in tutte le sue fasi.
